...
void setup()
{
  ...
  // Starter I2S-driveren
  i2s_driver_install(I2S_NUM_0, &i2s_config, 0, NULL);

  // Forteller ESP32 hvilke pins som er koblet til mikrofonen
...
void loop()
{
  ...
  // Summerer "styrke" i blokken (absoluttverdi, etter skalering)
  int64_t sum = 0;
  for (int i = 0; i < count; i++)
  {
    sum += llabs(samples[i] >> 14);
  }

  // Gjennomsnittlig styrke = level
  int level = (int)(sum / count);
