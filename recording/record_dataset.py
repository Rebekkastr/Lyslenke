...
PORT = "COM3" # Definerer hvilken port som skal brukes 
BAUD = 115200 # ønsker 115200 bits per sekund fra ESP32 til PC
N_SAMPLES = 40000 # Antall samples jeg vil ha til CSV filen
...
print(f"Steg 1: ta opp {N_SAMPLES} samples")
...
with open("data2.csv", "w", newline="") as file:
    ...
    csvwriter.writerow(["Sample"]) # header på første rad 
